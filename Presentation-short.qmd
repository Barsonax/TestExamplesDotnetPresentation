...
{
    UserName = "", // Does it make sense having to set UserName to a empty string here?
...
<span class="fragment">In memory testserver..</span><span class="fragment"> met wat limitaties</span>
